...
export default function FacultyForm() {
    ...
    useEffect(() => {
        ...
        axios
        .get(`https://portal-k7lh.onrender.com/teacher/send-details/${studentName}`)
        .then((res) => {
    ...
    const handleSubmit = (e) => {
        ...
        e.preventDefault();
        axios
            .post(`https://portal-k7lh.onrender.com/teacher/upload-faculty-marks/${studentName}`, inputs, {
                headers: {
